...
在二进制中，$$1$。但因为我们只能存储3位，所以最高位的1会被丢失。这就是所谓的溢出（overflow），最终结果变成了000。
...
- 加法运算变得复杂。例如，$$1$应该等于0，但$$1$，这反而等于-2
...
| UMax | $$1$ | 65535  | 11111111 11111111 |

### 二进制补码范围

| 边界   | 计算公式        | 16位示例值 | 二进制模式             |
| ---- | ----------- | ------ | ----------------- |
| TMin | $$1$  | -32768 | 10000000 00000000 |
| TMax | $$1$ | 32767  | 01111111 11111111 |
