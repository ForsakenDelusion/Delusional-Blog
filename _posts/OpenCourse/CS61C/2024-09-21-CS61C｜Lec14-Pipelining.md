...
![CS61C｜Lec14-Pipelining-20250122.png](../../../assets/images/cs61c｜lec14-pipelining-20250122.png)

![CS61C｜Lec14-Pipelining-20250122-1.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-1.png)
...
![CS61C｜Lec14-Pipelining-20250122-2.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-2.png)

注意，这里的Reg Read/Write只需要100ps，这点我们在后面会提到

![CS61C｜Lec14-Pipelining-20250122-3.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-3.png)

注意，Register Read/Write因为要和流水线中延迟最大的一部分一样，所以时间也变成了200ps。如果短于这个时间，有些操作还没结束就到下一个时钟周期了。

![CS61C｜Lec14-Pipelining-20250122-4.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-4.png)

![CS61C｜Lec14-Pipelining-20250122-5.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-5.png)

观察or指令，实际上他的DMEM并没有被用上，他只是在等add用完Reg而已。

## Pipelining Datapath

![CS61C｜Lec14-Pipelining-20250122-6.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-6.png)

![CS61C｜Lec14-Pipelining-20250122-7.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-7.png)

注意右上角的加4的加法器，那是用于优化设计采用的方案。

如果我们不加这个加法器，那么我们就需要用三个寄存器来保存PC+4。就像下面这样

![CS61C｜Lec14-Pipelining-20250122-8.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-8.png)

下面是命令和流水线数据通路的示意图

![CS61C｜Lec14-Pipelining-20250122-9.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-9.png)

## Pipelined Control

![CS61C｜Lec14-Pipelining-20250122-10.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-10.png)
...
![CS61C｜Lec14-Pipelining-20250122-11.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-11.png)

### Instruction and Data Caches

CPU上的高速缓存

![CS61C｜Lec14-Pipelining-20250122-12.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-12.png)
...
![CS61C｜Lec14-Pipelining-20250122-13.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-13.png)
...
![CS61C｜Lec14-Pipelining-20250122-14.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-14.png)

下面的所有指令都依赖于s0，但是s0在add指令快结束的时候才会被写会寄存器，这导致了后面的两条指令得到了错误的s0。

### Solution 1: Stalling

![CS61C｜Lec14-Pipelining-20250122-15.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-15.png)
...
![CS61C｜Lec14-Pipelining-20250122-16.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-16.png)
...
![CS61C｜Lec14-Pipelining-20250122-17.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-17.png)

![CS61C｜Lec14-Pipelining-20250122-18.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-18.png)

## Data Hazards(Load)

在lw操作中，DMEM之后才能获得数，这就意味着我们需要将书传到下一条指令的前一个周期，但是在流水线中，我们不能后退。

![CS61C｜Lec14-Pipelining-20250122-19.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-19.png)
...
![CS61C｜Lec14-Pipelining-20250122-20.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-20.png)
...
![CS61C｜Lec14-Pipelining-20250122-21.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-21.png)

## Control Hazards

控制冒险：也称为分支冒险，由于取到的指令并不是所需要的，或者指令地址的流向不是流水线所预期的，导致正确的指令无法在正确的时钟周期内执行。

![CS61C｜Lec14-Pipelining-20250122-22.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-22.png)
...
![CS61C｜Lec14-Pipelining-20250122-23.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-23.png)
...
![CS61C｜Lec14-Pipelining-20250122-24.png](../../../assets/images/cs61c｜lec14-pipelining-20250122-24.png)
