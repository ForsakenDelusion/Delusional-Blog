...
我觉得当初我做这部分笔记的时候对这块内容理解还太浅薄，所以这部分内容可以移步至[2025-02-21-Numbers-representation](../../study/studyrecord/2025-02-21-numbers-representation.md)进行参考。
...
![CS61C-Representation of Number & C Basic-20250122.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122.png)
...
![CS61C-Representation of Number & C Basic-20250122-1.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-1.png)
...
- One's Complement 🙅
	...
	- The name "ones' complement" refers to the fact that such an inverted value, if added to the original, would always produce an "all ones" number

    - Flipping all the bits when number is negative.
        
        - e.g. $$7_{10} = 00111_2$$ (7 in decimal is 0111 in binary), $$-7_{10} = 11000_2$$ (in 4-bit two's complement representation)

            
![CS61C-Representation of Number & C Basic-20250122-2.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-2.png)
...
![CS61C-Representation of Number & C Basic-20250122.jpg](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122.jpg)

Save storage space

![CS61C-Representation of Number & C Basic-20250122-3.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-3.png)
...
![CS61C-Representation of Number & C Basic-20250122-4.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-4.png)
...
![CS61C-Representation of Number & C Basic-20250122-5.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-5.png)
...
![CS61C-Representation of Number & C Basic-20250122-6.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-6.png)
...
![CS61C-Representation of Number & C Basic-20250122-7.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-7.png)
...
![CS61C-Representation of Number & C Basic-20250122-8.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-8.png)
...
![CS61C-Representation of Number & C Basic-20250122-9.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-9.png)
...
![CS61C-Representation of Number & C Basic-20250122-1.jpg](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-1.jpg)

![CS61C-Representation of Number & C Basic-20250122-10.png](../../../assets/images/cs61c-representation-of-number-&-c-basic-20250122-10.png)
