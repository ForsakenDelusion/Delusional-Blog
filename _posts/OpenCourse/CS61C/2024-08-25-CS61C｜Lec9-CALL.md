...
share: true
---
![CS61C｜Lec9-CALL-20250122.png](../../../assets/images/cs61c｜lec9-call-20250122.png)
...
![CS61C｜Lec9-CALL-20250122-1.png](../../../assets/images/cs61c｜lec9-call-20250122-1.png)
...
- `a = b = c;`，编译器需要知道赋值运算符 `=` 的结合方式。在这里，赋值运算符从右向左结合，因此先执行 `b = c`，再执行 `a = b`。如果 `b` 和 `c` 的值相同，则 `a` 也会获得相同的值
...
![CS61C｜Lec9-CALL-20250122-2.png](../../../assets/images/cs61c｜lec9-call-20250122-2.png)
